...
public class VLCInstance {
    ...
    private static Runnable sCopyLua = new Runnable() {
        ...
        public void run() {
            String destinationFolder = AndroidDevices.EXTERNAL_PUBLIC_DIRECTORY+
                    "/Android/data/"+VideoPlayerApp.getAppContext().getPackageName()+"/lua";
            AssetManager am = VideoPlayerApp.getAppResources().getAssets();
    ...
    public static void linkCompatLib(Context context) {
        ...
        try {
            is = VideoPlayerApp.getAppResources().getAssets().open("libcompat.7.so");
...
//                    context.startActivity(i);
            ...
            VideoPlayerApp.runBackground(sCopyLua);
        }
        return sLibVLC;
    }
