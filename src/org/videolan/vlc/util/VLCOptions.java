...
public class VLCOptions {
    ...
    public static ArrayList<String> getLibOptions() {
        final Context context = VideoPlayerApp.getAppContext();
        final SharedPreferences pref = PreferenceManager.getDefaultSharedPreferences(context);

        ArrayList<String> options = new ArrayList<String>(50);

        final boolean timeStrechingDefault = VideoPlayerApp.getAppResources().getBoolean(R.bool.time_stretching_default);
        ...
        String chroma = pref.getString("chroma_format", VideoPlayerApp.getAppResources().getString(R.string.chroma_format_default));
        if (chroma != null)
