...
//    public static final int INDEX_MEDIA_LAST_MODIFIED = 18;
    ...
    public synchronized static MediaDatabase getInstance() {
        if (instance == null) {
            instance = new MediaDatabase(VideoPlayerApp.getAppContext());
        }
        return instance;
    }
    ...
    private static class DatabaseHelper extends SQLiteOpenHelper {
        ...
        public SQLiteDatabase getWritableDatabase() {
            ...
            try {
                ...
                try {
                    db = SQLiteDatabase.openOrCreateDatabase(VideoPlayerApp.getAppContext().getDatabasePath(DB_NAME), null);
